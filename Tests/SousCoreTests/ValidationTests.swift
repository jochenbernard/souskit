...
// Version 0.2 defines no intra-file validation rules (the first arrives in v0.3), so
// a well-formed recipe validates without any diagnostics. These tests document that
// v0.2 contract; they hold against the current no-op and guard it against regressions.
